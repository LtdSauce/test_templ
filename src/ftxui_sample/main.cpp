...
// configuration step. It creates a namespace called `test_templ`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", test_templ::cmake::project_name, test_templ::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", test_templ::cmake::project_version);
      return EXIT_SUCCESS;
    }
